  ...
  <section class="navbar-section">
    <div class="container">
      <nav class="py-3 d-flex align-items-center justify-content-between border-bottom">
        <div class="logo">
          <a href="index.html">
            <img src="images/Fashion Fusion-logos_black.png" height="40" alt="">
          </a>
        </div>
        <div class="nav-menu">
                ...
                <div class="card h-100 bg-transparent border-white">
                  <div class="card-body text-white">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="images/podcaster-template-reviewer-1.jpg" class="rounded-circle" alt="">
                      <div>
              ...
              <div class="col">
                <div class="card h-100 bg-transparent border-white">
                  <div class="card-body text-white">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="images/podcaster-template-reviewer-2.jpg" class="rounded-circle" alt="">
                      <div>
              ...
              <div class="col">
                <div class="card h-100 bg-transparent border-white">
                  <div class="card-body text-white">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="images/podcaster-template-reviewer-3.jpg" class="rounded-circle" alt="">
                      <div>
              ...
              <div class="col">
                <div class="card h-100 bg-transparent border-white">
                  <div class="card-body text-white">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="images/podcaster-template-reviewer-4.jpg" class="rounded-circle" alt="">
                      <div>
              ...
              <div class="col">
                <div class="card h-100 bg-transparent border-white">
                  <div class="card-body text-white">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="images/podcaster-template-reviewer-5.jpg" class="rounded-circle" alt="">
                      <div>
              ...
              <div class="col">
                <div class="card h-100 bg-transparent border-white">
                  <div class="card-body text-white">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="images/podcaster-template-reviewer-6.jpg" class="rounded-circle" alt="">
                      <div>
